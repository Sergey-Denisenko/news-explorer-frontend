...
function App() {
  ...
  //   .catch((err) => {
  //     if(err === 400) {
  // Отработка ошибок в попапе редактирования инфо о пользователе
  //       setMessage('Одно из полей заполнено не корректно');
  //     } else
  //     {
  // Отработка ошибок в попапе редактирования инфо о пользователе
  ...
  //   const [isHeaderAuthButtonClick, setIsHeaderAuthButtonClick] = React.useState(false);
  //   const handleHeaderAuthButtonClick = () => {
  //     setIsHeaderAuthButtonClick(!isHeaderAuthButtonClick);
  // };
          ...
          <Switch>
            <Route path="/saved-news">
              <Header
                ...
                handleHeaderAuthButtonClick={handleHeaderAuthButtonClick} routePathSavedNews={ '/saved-news' }
                routePathMainPage={ '/' }
            ...
            <Route path="/">
              ...
              {/* <NewsCardList showMore={showMore} isMainPageOpen={isMainPageOpen}
              isSavedNewsPageOpen={isSavedNewsPageOpen} handleShowTooltip={handleShowTooltip}
              isShowTooltip={isShowTooltip} handleShowMoreClick={handleShowMoreClick} /> */}
              <Preloader />
              <NotFound />
              <About />
            </Route>
